...
public class Util_VisEdu : MonoBehaviour {
    ...
    { 
        ...
        if (CuboVisObjectMain != null) CuboVisObjectMain = Instantiate(CuboVisObjectMain, CuboVisObjectMain.transform.position, CuboVisObjectMain.transform.rotation, CuboVisObjectMain.transform.parent);
        if (PosicaoAmb != null) PosicaoAmb = Instantiate(PosicaoAmb, PosicaoAmb.transform.position, PosicaoAmb.transform.rotation, PosicaoAmb.transform.parent);
